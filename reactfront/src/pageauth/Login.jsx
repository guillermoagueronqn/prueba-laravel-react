    ...
    return (
        <div className="flex-grow">
            ...
            <form className="max-w-sm mx-auto">
                ...
                <span className="ml-5 sm:mt-5"><a href="/register" className="font-medium text-blue-700 text-primary-600 hover:text-blue-800 dark:text-primary-500">Crear cuenta</a></span>
            </form>
        </div>
    )
}
